...
// Generate secure password hash - https://github.com/lelegoyengdocs/pwd.html
$auth_users = array(
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/2022';
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://github.com/lelegoyeng" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Kevin Ru</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/lelegoyeng" target="_blank" class="app-v-title"> Test File Manager V1.0 </a></h3></p>
                        <p>Author: Kevin Rubama</p>
                        <p>Mail Us: <a href="mailto:lelegoyens@gmail.com">lelegoyengs@gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/lelegoyeng" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://github.com/lelegoyeng" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
                                <?php } ?>
                            </ul>
                        </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://github.com/lelegoyeng" target="_blank" class="float-right text-muted">Lelegoyeng v1.0</a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://github.com/lelegoyeng" target="_blank" class="float-right text-muted">Lelegoyeng v1.0</a></div>
        <?php endif; ?>
    </div>
...
<head>
    ...
    <meta name="author" content="Kevin Rubama">
...
<script>
    ...
    //TFM Config
    window.curi = "https://github.com/lelegoyengconfig.json", window.config = null;
